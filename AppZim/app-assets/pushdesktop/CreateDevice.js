var applicationServerPublicKey = 'BLV67mH2vJ089lrdChQhSzSwJgWXvpKBdwgZ-AzuDpmlKGlZPtCbH_AD28gDnd7u42srBlEQLmbRYf46thgGIzI';
    ...
    navigator.serviceWorker.ready.then(function (reg) {
        ...
        reg.pushManager.subscribe(subscribeParams)
            .then(function (subscription) {
                ...
                $.ajax({
                    type: "POST",
                    url: "/Admin/Account/InsertDevicetoken",
                    data: '{PushEndpoint: "' + subscription.endpoint + '", PushP256DH: "' + p256dh + '", PushAuth: "' + auth + '"}',
